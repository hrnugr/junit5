...
public class AssertionsDemo {
    ...
    private final Person person = new Person("Ramiz", "Karaeski");
    ...
    void groupedAssertions() {
        ...
        assertAll("person",
                () -> assertEquals("Ramiz", person.getName()),
                () -> assertEquals("Karaeski", person.getSurname())
        );
    }
        ...
        assertAll("properties",
                () -> {
                    ...
                    assertAll("first name",
                            ...
                            () -> assertTrue(firstName.endsWith("z"))
                    );
                },
                () -> {
    ...
    void timeoutNotExceededWithMethod() {
        ...
        String actualGreeting = assertTimeout(ofMinutes(2), helloWorld::greeting);
